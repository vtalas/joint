function HypothesisFn(self) {
    var hypothesisNode = self.joint.shapes.devs.Model.extend({
        ...
        defaults: self.joint.util.deepSupplement({
            type: 'devs.Hypothesis',
            attrs: {
                rect: { stroke: '#CCC' },
                '.body': { stroke: 'none', fill: 'transparent' },
                '.label': {
                    text: '', 'ref-x': 45, 'ref-y': 40, 'x-alignment': 'middle', ref: '.body',
                    style: { 'font-size': 12, 'font-weight': 'Semi-Bold', fill: '#666666' },
                },
                // title: { text: self.translator.translate('HYPOTHESIS') },
                title: { text: 'hypo' },
                '.icon': {
                    'xlink:href': 'images/icons-separate/hypothesis.png', 'ref-width': 1, 'ref-height': 1, ref: '.body'
                },
            },
            inPorts: ['in'],
            outPorts: ['out'],
